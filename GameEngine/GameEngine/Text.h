...
int main_temp()
{
    ...
    GLuint shaderProgram = LoadShaders("shaders/text.vs", "shaders/text.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        RenderText(shaderProgram, "(C) LearnOpenGL.com", 540.0f, 570.0f, 0.5f, glm::vec3(0.3, 0.7f, 0.9f));
